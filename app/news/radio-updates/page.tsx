...
export default function RadioUpdatesPage() {
  const [items, setItems] = useState<NewsItem[]>([]);

  useEffect(() => {
    fetch("/api/news?category=radio-updates")
      .then((res) => res.json())
      ...
      <section className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 rounded-[2rem] border-2 border-red-600 bg-gradient-to-br from-yellow-200 via-amber-300 to-yellow-500 p-8 text-black">
          ...
          <p className="mt-4 max-w-3xl text-lg font-bold">
            Live station news, DJ drops, show announcements, schedule updates, and new Tha Core features.
          </p>
        </div>
