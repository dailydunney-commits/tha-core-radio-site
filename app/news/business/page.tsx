    ...
    <main className="min-h-screen bg-black px-6 py-10 text-white">
      <section className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 rounded-[2rem] border-2 border-red-600 bg-gradient-to-br from-yellow-200 via-amber-300 to-yellow-500 p-8 text-black">
          ...
          <p className="mt-4 max-w-3xl text-lg font-bold">Business updates, money moves, sponsor slots, ads, printing deals, and opportunities.</p>
        </div>
        ...
        <div className="mt-8 grid gap-5">
          <article className="rounded-3xl border border-red-700 bg-zinc-950 p-6 shadow-[0_0_35px_rgba(34,197,94,.35)]">
            ...
            <h2 className="mt-3 text-2xl font-black text-white">Business updates will show here.</h2>
          ...
          <article className="rounded-3xl border border-red-700 bg-zinc-950 p-6 shadow-[0_0_35px_rgba(34,197,94,.35)]">
            ...
            <h2 className="mt-3 text-2xl font-black text-white">More Business content coming soon.</h2>
            <p className="mt-3 text-gray-300">
