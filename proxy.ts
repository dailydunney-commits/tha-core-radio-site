...
export function proxy(request: NextRequest) {
  ...
  const smartZjInternalPath =
    ...
    smartZjPathname === "/api/radio/ai-host-long-show-schedule-guard" ||
    smartZjPathname.startsWith("/api/radio/ai-host-long-show-schedule-guard/") ||
    smartZjPathname === "/api/radio/ai-host-long-show-master-feeder" ||
    smartZjPathname.startsWith("/api/radio/ai-host-long-show-master-feeder/") ||
    smartZjPathname === "/api/radio/ai-host-long-show-voice-package" ||
    smartZjPathname.startsWith("/api/radio/ai-host-long-show-voice-package/") ||
    smartZjPathname === "/api/radio/ai-host-long-show-live-runner" ||
    smartZjPathname.startsWith("/api/radio/ai-host-long-show-live-runner/") ||
  ...
  if (
    ...
    safeBackendPathname.startsWith("/api/radio/smartdj-auto-brain/") || safeBackendPathname.startsWith("/api/radio/smartdj-clean-next/") || safeBackendPathname === "/api/radio/smartdj-second-scan" || safeBackendPathname.startsWith("/api/radio/smartdj-second-scan/") || safeBackendPathname === "/api/radio/smartdj-azura-scan-load" || safeBackendPathname.startsWith("/api/radio/smartdj-azura-scan-load/") || safeBackendPathname === "/api/radio/smartdj-background-clean" || safeBackendPathname.startsWith("/api/radio/smartdj-background-clean/") || safeBackendPathname === "/api/radio/smartdj-auto-clean" || safeBackendPathname.startsWith("/api/radio/smartdj-auto-clean/") || safeBackendPathname === "/api/radio/safe-action" ||
      ...
      safeBackendPathname === "/api/radio/ai-host-long-show-schedule-guard" ||
      safeBackendPathname.startsWith("/api/radio/ai-host-long-show-schedule-guard/") ||
      safeBackendPathname === "/api/radio/ai-host-long-show-master-feeder" ||
      safeBackendPathname.startsWith("/api/radio/ai-host-long-show-master-feeder/") ||
      safeBackendPathname === "/api/radio/ai-host-long-show-voice-package" ||
      safeBackendPathname.startsWith("/api/radio/ai-host-long-show-voice-package/") ||
      safeBackendPathname === "/api/radio/ai-host-long-show-live-runner" ||
      safeBackendPathname.startsWith("/api/radio/ai-host-long-show-live-runner/") ||
...
// REAL_BLEEP_PROCESSOR_DEV_ALLOWLIST
  ...
  const isAiHostWeekendProgramDryRoute =
    ...
    pathname === "/api/radio/ai-host-long-show-schedule-guard" ||
    pathname === "/api/radio/ai-host-long-show-master-feeder" ||
    pathname === "/api/radio/ai-host-long-show-voice-package" ||
    pathname === "/api/radio/ai-host-long-show-live-runner";
